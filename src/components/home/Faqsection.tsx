...
const faqs: FAQItem[] = [
  {
    question: "What is GrowMoreReviews?",
    answer:
      "GrowMoreReviews is a platform that helps local businesses collect more Google reviews, track their review activity in one dashboard, and see how their growth compares to nearby competitors.",
  },
  {
    question: "How does the review request process work?",
    answer:
